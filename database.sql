use master
go
if exists(select name from Sys.databases where name= 'QLThuViennam') drop database QLThuViennam
go
create database QLThuViennam
go
use QLThuViennam
go
...
go
insert into Muontrasach values('d001', 's001', '2021/01/10', '2021/01/20', '2021/01/18',1)
insert into Muontrasach values('d002', 's001', '2021/01/7', '2021/01/15', '2021/01/13',2)
insert into Muontrasach values('d003', 's003', '2021/01/9', '2021/01/14', '2021/01/14',1)
go
create table HoaDon(
